# Tradeliste für mehrere Signallisten (unsortiert)


def tradelisteMulti(name, datum, open, high, low, close, signalLMulti):

    tradeL = []
    tradeCount = 0

    for isignalMulti in range(len(signalLMulti)):
        signalL = signalLMulti[isignalMulti]
